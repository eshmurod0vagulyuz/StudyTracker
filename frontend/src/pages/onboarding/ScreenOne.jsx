  ...
  return (
    <div className="min-h-dvh flex flex-col bg-primary">
      ...
      <div className="px-6 pb-10 flex flex-col gap-3">
        <Button onClick={onNext} className="bg-white text-primary hover:bg-white/90">{nextLabel}</Button>
        {onSkip && (
          <button onClick={onSkip} className="text-white/70 text-sm font-semibold py-2">Skip</button>
        )}
      </div>
    </div>
  )
...
export default function ScreenOne() {
  ...
  return (
    <OnboardingLayout
      ...
      description="Organize your study tasks, track your progress, and achieve your academic goals efficiently."
      step={1} total={3}
